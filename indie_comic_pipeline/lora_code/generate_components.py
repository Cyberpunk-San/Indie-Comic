"""
SDXL + LORA COMIC COMPONENT GENERATOR
...
print("=" * 70)
print("SDXL + LORA COMIC COMPONENT GENERATOR - Generating assets")
print("=" * 70)
...
print("\nGenerating comic comic components...")
print("-" * 50)
...
if component_paths:
    ...
    grid_path = get_output_path(comics_dir, "component_sheet_sdxl_lora_grid_2x2.png")
    create_comic_grid(component_paths, grid_path, grid_size=grid_size, cell_size=(width, height))
    print(f"Saved dynamic component sheet grid to: {grid_path}")
else:
    print("Error: No components were successfully generated.")
    sys.exit(1)

# Run character consistency checks using the character reference profile generated by SDXL LoRA
ref_path = get_output_path(char_dir, "character_reference_sdxl_lora.png")
