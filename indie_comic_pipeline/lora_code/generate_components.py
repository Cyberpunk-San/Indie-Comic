"""
SDXL + LORA COMIC COMPONENT GENERATOR - T4 OPTIMIZED
Generates individual visual assets/components (main character pose, extra person, environment background, props)
Optimized for T4 GPU with memory management and model caching
"""
...
print("=" * 70)
print("SDXL + LORA COMIC COMPONENT GENERATOR - T4 OPTIMIZED")
print("Generating assets with efficient memory management")
print("=" * 70)
...
def get_pipeline(settings, device, force_reload=False):
    ...
    print("\n  Loading SDXL pipeline (first time, caching for future use)...")
...
for i, component in enumerate(components):
    ...
    raw_negative = "extra fingers, deformed face, bad anatomy, character design changes, photorealistic, 3d render, ugly"
    ...
    try:
        ...
        component_path = get_output_path(comics_dir, f"component_sdxl_lora_{i+1}.png")
        ...
        try:
            ...
            component_path = get_output_path(comics_dir, f"component_sdxl_lora_{i+1}_fallback.png")
            image.save(component_path)
            component_paths.append(component_path)
...
if component_paths:
    ...
    strip_path = get_output_path(comics_dir, "component_sheet_sdxl_lora_horizontal.png")
    ...
    grid_path = get_output_path(comics_dir, "component_sheet_sdxl_lora_grid.png")
...
print("   - component_sdxl_lora_1.png through component_sdxl_lora_N.png")
print("   - component_sheet_sdxl_lora_horizontal.png")
print("   - component_sheet_sdxl_lora_grid.png")
print("=" * 70)