...
def build_notebook():
    ...
    cells.append({
        ...
        "source": [
            ...
            "EXTREME_QUALITY = False  # Enable 896x896 resolution, 40 steps, IP-Adapter, CLIP/DINOv2\n",
            "\n",
            "import yaml, os\n",
            "\n",
            ...
            "    \n",
            "print(f\" Settings: {CHARACTER_NAME} x {STORY_WORLD} | ExtremeQuality={EXTREME_QUALITY}\")"
        ]
    })
