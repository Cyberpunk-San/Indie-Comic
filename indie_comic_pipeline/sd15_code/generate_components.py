"""
SD 1.5 COMIC COMPONENT GENERATOR WITH LORA
...
print("=" * 70)
print("SD 1.5 COMIC COMPONENT GENERATOR WITH LORA - Generating assets")
print("=" * 70)
...
try:
    ...
    if os.path.exists(ref_path):
        ...
        try:
            ...
            # For SD 1.5, we load the standard SD 1.5 IP-Adapter
...
if component_paths:
    ...
    grid_path = get_output_path(comics_dir, "component_sheet_sd15_grid_2x2.png")
...
# Run character consistency checks using the character reference profile generated by SD 1.5
ref_path = get_output_path(char_dir, "character_reference_sd15.png")
