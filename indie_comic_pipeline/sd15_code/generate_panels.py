"""
SD 1.5 EMOTION-AWARE PANEL GENERATOR WITH LORA
...
print("=" * 70)
print("SD 1.5 EMOTION-AWARE PANEL GENERATOR - Drawing the story")
print("=" * 70)
...
try:
    ...
    try:
        ...
        print(f"Warning: Could not load LoRA weights directly into SD 1.5: {e}")
    ...
    if os.path.exists(ref_path):
        ...
        try:
            ...
            # For SD 1.5, we always load the standard SD 1.5 IP-Adapter since FaceID SDXL models won't fit/work.
