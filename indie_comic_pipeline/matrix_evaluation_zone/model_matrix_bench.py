...
test_output_dir = "/content/drive/MyDrive/Indie_Comic_Project/Indie-Comic-main/indie_comic_pipeline/matrix_evaluation_zone/outputs"
...
def run_stable_diffusion_v15():
    print("\n⏳ Loading Stable Diffusion v1.5 Base Model into GPU Memory...")
...
if __name__ == "__main__":
    ...
    # 1. Run generation loop and extract inference speed
    img_path, inf_time = run_stable_diffusion_v15()
